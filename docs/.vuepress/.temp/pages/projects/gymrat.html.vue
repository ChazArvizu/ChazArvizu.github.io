...
<ul>
<li>We used flutter for our frontend development because it provided a way for us to only have to code something once and have code that can be compiled to both Android and IOS applications. We used a tool called FlutterFlow which also helped to speed up our development process.</li>
</ul>
</li>
<li>
<p><strong>Backend</strong>: Firebase</p>
<ul>
<li>Firebase is a Backend as a service that provided us many &quot;out of the box&quot; services to implement in our app. The services that we used were the realtime database, authentication and cloud storage. Firebase also seamlessly integrates with Flutter because they are both developed/maintained by Google. FlutterFlow made it easy to configure Firebase in our application via a service account which made all the automated changes to the Firebase based on the configurations we input.</li>
</ul>
</li>
</ul>
<h2 id="services" tabindex="-1"><a class="header-anchor" href="#services"><span>Services</span></a></h2>
<ul>
<li><strong>Jira</strong>: Project management software that helped us plan sprints and assign tasks.</li>
<li><strong>Github</strong>: Version control system</li>
</ul>
<h2 id="features" tabindex="-1"><a class="header-anchor" href="#features"><span>Features</span></a></h2>
<ul>
<li>User authentication and authorization</li>
<li>Meal creation and management</li>
<li>Meal tracking</li>
<li>Workout routine creation and management</li>
<li>Workout tracking</li>
<li>Goal creation and management</li>
</ul>
</div></template>
